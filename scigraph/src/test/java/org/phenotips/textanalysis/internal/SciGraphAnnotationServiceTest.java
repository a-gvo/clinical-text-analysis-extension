...
public class SciGraphAnnotationServiceTest
{
    ...
    public void testSingleAnnotation() throws AnnotationException, ComponentLookupException, IOException
    {
        ...
        List<SciGraphWrapper.SciGraphAnnotation> result = new LinkedList<SciGraphWrapper.SciGraphAnnotation>();

        /* Mock SciGraph wrapper */
        SciGraphWrapper wrapper = this.mocker.getInstance(SciGraphWrapper.class);
        SciGraphWrapper.SciGraphAnnotation.Token token = new SciGraphWrapper.SciGraphAnnotation.Token();
        token.setId(termId);
        SciGraphWrapper.SciGraphAnnotation annotation = new SciGraphWrapper.SciGraphAnnotation();
    ...
    public void testOverlappingAnnotations() throws AnnotationException, ComponentLookupException, IOException
    {
        ...
        SciGraphWrapper.SciGraphAnnotation.Token token1 = new SciGraphWrapper.SciGraphAnnotation.Token();
        token1.setId(termId1);
        SciGraphWrapper.SciGraphAnnotation annotation1 = new SciGraphWrapper.SciGraphAnnotation();
        annotation1.setToken(token1);
        annotation1.setStart(start1);
        annotation1.setEnd(end1);
        result.add(annotation1);

        SciGraphWrapper.SciGraphAnnotation.Token token2 = new SciGraphWrapper.SciGraphAnnotation.Token();
        token2.setId(termId2);
        SciGraphWrapper.SciGraphAnnotation annotation2 = new SciGraphWrapper.SciGraphAnnotation();
